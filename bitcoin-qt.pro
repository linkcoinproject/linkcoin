...
# NOTE: These are default Windows paths, override them via qmake command line
# Example: qmake BOOST_INCLUDE_PATH=/path/to/boost ...
...
# on Windows: enable GCC large address aware linker flag (32-bit only, disabled for x86_64)
# win32:QMAKE_LFLAGS *= -Wl,--large-address-aware -static
# i686-w64-mingw32
win32:QMAKE_LFLAGS *= -static -static-libgcc -static-libstdc++
# Disable tablet events to avoid undefined reference errors
win32:DEFINES += QT_NO_TABLETEVENT
...
contains(USE_UPNP, -) {
    ...
    # Windows libraries for UPnP must come AFTER miniupnpc
...
# gdi32 is added via Makefile patching after crypto, so removed from here to avoid duplication
