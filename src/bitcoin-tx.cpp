...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " linkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  linkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded linkcoin transaction\n" +
            "or:     linkcoin-tx [options] -create [commands]   Create hex-encoded linkcoin transaction\n" +
            "\n";
